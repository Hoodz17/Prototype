...
<div class="container max-width-sm padding-y-lg">
    <form action="<?=BACKENDROOT?>CollectionsController/create" method="POST">
        <fieldset class="margin-bottom-md">
            <legend class="form-legend">Create Collection</legend>
            <div class="grid gap-sm">
                <div class="col-6@md">
                    <label class="form-label margin-bottom-xxs" for="input-name">Collection Name</label>
                    <input class="form-control width-100%" type="text" name="collectionName" id="collectionName" required>
                </div>
            </div>
        </fieldset>
        <div>
