...
class ScreenModel
{
    ...
    {
        $this->db->query(' SELECT screenId, screenMainId, screenPath, m.mainName, screenCreateDate, screenIsActive
                               FROM screens as s
    ...
    public function createScreen($post, $screenId, $imgPath){
        $this->db->query('INSERT INTO screens(screenId,screenMainId, screenPath, screenCreateDate, screenIsActive)
                          VALUES (:screenId,:screenMainId,:screenPath, :screenCreateDate, :screenIsActive);');
